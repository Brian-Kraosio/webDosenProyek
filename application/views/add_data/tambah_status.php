                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST">
                        <div class="form-group">
                            ...
                            <input type="number" name="id_status" class="form-control" id="id_status" placeholder="ID Status">
                        </div>
                        <div class="form-group">
                            <label for="status">Status Name</label>
                            <input type="text" name="status" class="form-control" id="status" placeholder="Status Name"> 
                        </div>
                        <div class="form-group">
                            <label for="kode_status">Status Code</label>
                            <input type="text" name="kode_status" class="form-control" id="kode_status" placeholder="Status Code"> 
                        </div>
                            <br>
