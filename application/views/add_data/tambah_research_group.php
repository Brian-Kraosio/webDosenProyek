                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST">
                        <div class="form-group">
                            ...
                            <input hidden type="number" name="id_research_group" class="form-control" id="id_research_group" placeholder="ID Research Group"  style="font-size: 20px !important">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="year" class="form-control" id="year" placeholder="exp : 2019" >
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="priority" class="form-control" id="priority" placeholder="Primary / secondary">
                        </div>
                        <br>
