                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST">
                        <div class="form-group">
                            ...
                            <input hidden type="number" name="id_menjabat" class="form-control" id="id_menjabat" placeholder="ID Menjabatan"  style="font-size: 20px !important">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="tahun_menjabat" class="form-control" id="tahun_menjabat" placeholder="exp : 2019" >
                        </div>
                        <div class="form-group">
                            <label for="Semester_menjabat" style="font-size: 20px !important">Semester lecturer positioned</label>
                            <input type="text" name="semester_menjabat" class="form-control" id="semester_menjabat" placeholder="Odd / Even ">
                        </div>
                        <br>
