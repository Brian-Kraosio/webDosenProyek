                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST">
                        <div class="form-group">
                            ...
                            <input type="number" name="NIP" class="form-control" id="" placeholder="NIP" style="font-size: 20px !important">
                        </div>
                        <div class="form-group">
                            <label for="NIDN" style="font-size: 20px !important">NIDN</label>
                            <input type="number" name="NIDN" class="form-control" id="NIDN" placeholder="NIDN" style="font-size: 20px !important">
                        </div>
                        <div class="form-group">
                            <label for="KODE" style="font-size: 20px !important">KODE Dosen</label>
                            <input type="text" name="KODE" class="form-control" id="KODE" placeholder="KODE DOSEN" style="font-size: 20px !important">
                        </div>
                        <div class="form-group">
                            <label for="Nama" style="font-size: 20px !important">Nama Dosen</label>
                            <input type="text" name="Nama" class="form-control" id="Nama" placeholder="Nama Dosen" style="font-size: 20px !important">
                        </div>
                        <div class="form-group">
