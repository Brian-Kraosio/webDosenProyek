            ...
            <div class="card bg-info text-white">
                ...
                <div class="card-body">
                    ...
                    <form action="" method="post" id="forminput" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label hidden for="RPS" style="font-size: 20px !important">RPS</label> <br>
                            <input hidden type="file" style="font-size: 20px !important" name="RPS"/>
                            <input hidden type="hidden" style="font-size: 20px !important" name="old_RPS" value="<?=$rpssap["RPS"]?>"/>
                        </div>
                        <div class="form-group">
                            <label for="SAP" style="font-size: 20px !important">SAP</label>
                            <input type="file" style="font-size: 20px !important" name="SAP"/>
