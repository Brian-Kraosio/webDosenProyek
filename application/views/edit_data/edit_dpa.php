                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST">
                        <div class="form-group">
                            ...
                            <input hidden type="number" name="id_DPA" class="form-control" id="id_DPA" placeholder="ID DPA" value="<?= $dpa['id_DPA'] ?>">
                        </div>
                        <div class="form-group">
                            <label for="KODE">KODE</label>
                            <input type="text" name="KODE" class="form-control" id="KODE" placeholder="KODE DOSEN" value="<?= $dpa['KODE'] ?>"> 
                        ...
                        <div class="form-group">
                            ...
                            <select name="kelas_dpa" id="kelas_dpa" class="form-control">
                                <?php foreach ($kelas as $kls) : ?>
                                    <?php if($dpa['kelas_dpa'] != null) : ?>
                                        <option value="<?= $dpa['kelas_dpa'] ?>" selected><?=$kls['nama_kelas']?></option>
                                    <?php else : ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" name="dpa_tahun" class="form-control" id="dpa_tahun" placeholder="exp : 2019" value="<?= $dpa['dpa_tahun'] ?>">
                        </div>
                        <div class="form-group">
                            <label for="semester" style="font-size: 20px !important">Homeroom Semester</label>
                            <input type="text" name="semester" class="form-control" id="semester" placeholder="Odd / Even " value="<?= $dpa['semester'] ?>">
                        </div>
                        <br>
