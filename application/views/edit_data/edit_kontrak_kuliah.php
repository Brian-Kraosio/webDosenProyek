                ...
                <div class="card-body">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <input hidden type="number" name="id_kontrak" class="form-control" id="id_kontrak" placeholder="ID Kontrak Kuliah" value="<?= $kontrak['id_kontrak'] ?>">
                        </div>
                        <div class="form-group">
                            <label for="id_matkul">Kode Mata Kuliah</label>
                            <input type="text" name="id_matkul" class="form-control" id="id_matkul" placeholder="KODE Mata Kuliah" value="<?= $kontrak['id_matkul'] ?>" >
                        ...
                        <div class="form-group">
                            ...
                            <input hidden  type="text" style="font-size: 20px !important" name="uplodaer" value="<?=$this->session->userdata('user')?>"  /><br><br>
                        </div>
                        <br>
