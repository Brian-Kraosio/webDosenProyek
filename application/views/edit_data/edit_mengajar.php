                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST">
                        <div class="form-group">
                            ...
                            <input type="number" name="id_mengajar" class="form-control" id="id_mengajar" placeholder="ID Mengajar" value="<?= $mengajar['id_mengajar'] ?>" >
                        </div>
                        <div class="form-group">
                            <label for="tipe_pelajaran">Tipe Pelajaran</label>
                            <input type="text" name="tipe_pelajaran" class="form-control" id="tipe_pelajaran" placeholder="Tipe Pelajaran" value="<?= $mengajar['tipe_pelajaran'] ?>"> 
                        </div>
                            <br>
