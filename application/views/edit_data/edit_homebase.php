                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST">
                        <div class="form-group">
                            ...
                            <input type="number" name="id_homebase" class="form-control" id="id_homebase" placeholder="ID Homebase" value="<?=$homebase['id_homebase']?>" hidden>
                        </div>
                        <div class="form-group">
                            <label for="nama_homebase">Homebase Name</label>
                            <input type="text" name="nama_homebase" class="form-control" id="nama_homebase" placeholder="Homebase Name" value="<?=$homebase['nama_homebase']?>"> 
                            <br>
