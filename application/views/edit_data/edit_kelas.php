                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST">
                        <div class="form-group">
                            ...
                            <input hidden type="number" name="id_kelas" class="form-control" id="id_kelas" value="<?= $kelas['id_kelas'] ?>" >
                        </div>
                        <div class="form-group">
                            <label style="font-size: 20px !important" for="nama_kelas">Class Name</label>
                            <input type="text" name="nama_kelas" class="form-control" id="nama_kelas" placeholder="Exp : TI - / MI -" value="<?= $kelas['nama_kelas'] ?>"> 
                            <br>
