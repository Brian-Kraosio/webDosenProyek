                ...
                <div class="card-body">
                    ...
                    <form action="" method="POST">
                        <div class="form-group">
                            ...
                            <input hidden type="number" name="id_jadwal_per_kelas" class="form-control" id="id_jadwal_per_kelas" value="<?= $jadwal_per_kelas['id_jadwal_per_kelas'] ?>" >
                        </div>
                        <div class="form-group">
                            <label for="kode">Kode Dosen</label>
                            <input type="text" name="kode" class="form-control" id="kod" placeholder="Kode Dosen" value="<?= $jadwal_per_kelas['kode'] ?>">
                        ...
                        <div class="form-group">
                            ...
                            <select name="id_kelas" id="id_kelas" class="form-control">
                                <?php foreach ($kelas as $kls) : ?>
                                    <?php if($jadwal_per_kelas['id_kelas'] != null) : ?>
                                        <option value="<?= $jadwal_per_kelas['id_kelas'] ?>" selected><?=$kls['nama_kelas']?></option>
                                    <?php else : ?>
                        ...
                        <div class="form-group">
                            ...
                            <input type="id_matkul" name="id_matkul" class="form-control" id="id_matkul" placeholder="Course" value="<?= $jadwal_per_kelas['id_matkul'] ?>">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="tahun_jadwal" class="form-control" id="tahun_jadwal" placeholder="Exp : 2019" value="<?= $jadwal_per_kelas['tahun_jadwal'] ?>">
                        </div>
                        <div class="form-group">
                            <label for="semester_jadwal" >Schedule Semester</label>
                            <input type="text" name="semester_jadwal" class="form-control" id="semester_jadwal" placeholder="Odd / Even" value="<?= $jadwal_per_kelas['semester_jadwal'] ?>">
                        </div>
                        <br>
